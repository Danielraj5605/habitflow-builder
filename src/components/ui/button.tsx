  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow border-0 font-semibold transition-bounce hover:scale-105",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft hover:shadow-medium",
        floating: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-medium hover:shadow-glow rounded-full fixed bottom-6 right-6 z-50 transition-bounce hover:scale-110",
        habit: "bg-card text-card-foreground border border-border hover:bg-accent hover:text-accent-foreground shadow-soft hover:shadow-medium transition-bounce hover:scale-[1.02]",
      },
      size: {
